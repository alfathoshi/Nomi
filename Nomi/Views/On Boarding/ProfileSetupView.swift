...
struct ProfileSetupView: View {
    ...
    var body: some View {
        VStack (alignment: .leading) {
            ...
            HStack(spacing: 25) {
                AvatarButton(avatar: "BoysAvatar", padding: 2, selectedAvatar: $selectedAvatar
                )
                AvatarButton(avatar: "GirlsAvatar", padding: 2, selectedAvatar: $selectedAvatar)
                AvatarButton(avatar: "Mascot",padding: 8, selectedAvatar: $selectedAvatar)
                AvatarButton(avatar: "Pip",padding: 8, selectedAvatar: $selectedAvatar)
            }
            .padding(.bottom, 20)
...
private struct OnboardingParentPasscodeView: View {
    ...
    var body: some View {
        ParentPasscodeView(mode: .create) {
